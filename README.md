...
- Categorise expenses (Food, Travel, Luxury, Bills)
- Record personal savings
- Create savings goals
- Allocate savings towards goals
...
- Debugging complex program logic
- Designing user-friendly program workflows

One of the biggest challenges was implementing the savings goal system while ensuring users could not allocate more funds than were available.
